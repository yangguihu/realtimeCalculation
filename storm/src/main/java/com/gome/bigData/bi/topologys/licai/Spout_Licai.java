 ...
 */
public class Spout_Licai implements IRichSpout {
    ...
    public void open(Map map, TopologyContext topologyContext, SpoutOutputCollector spoutOutputCollector) {
        ...
        //创建KafkaConsumer;
        KafkaConsumer consumer = new KafkaConsumer(zkHost, "realtime_licai_group", "realtime_licai");
        consumer.start();
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        outputFieldsDeclarer.declare(new Fields("licai_messages"));
    }
